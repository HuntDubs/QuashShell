\begin{quote}
\end{quote}
\hypertarget{index_autotoc_md0}{}\doxysection{E\+E\+C\+S 678 -\/ Quash Shell}\label{index_autotoc_md0}
...
A skeleton has been provided, but it lacks most of the core functionality one would expect from a shell program. Quash should behave similar to csh, bash or other popular shell programs.\hypertarget{index_autotoc_md2}{}\doxysubsection{Installation}\label{index_autotoc_md2}
...
\hypertarget{index_autotoc_md4}{}\doxysubsection{Features}\label{index_autotoc_md4}
{\itshape {\bfseries{The main file you will modify is \mbox{\hyperlink{execute_8c}{src/execute.\+c}}. You may not use or modify files in the src/parsing directory, with the notable exception of the destroy\+\_\+parser() function in src/parsing/parse\+\_\+interface.\+c if necessary. Your output should match our example result files exactly.}}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{[QUASH]\$ program1 \&}
\DoxyCodeLine{Background job started: [1]    2342    program1 \&}
\DoxyCodeLine{[QUASH]\$ ls}
\DoxyCodeLine{Documents Downloads}
\DoxyCodeLine{Completed: [1]    2342    program1 \&}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{[QUASH]\$ echo Hello Quash! > a.txt  \# Write "Hello Quash!\(\backslash\)n" to a file}
\DoxyCodeLine{[QUASH]\$ cat a.txt}
\DoxyCodeLine{Hello Quash!}
\DoxyCodeLine{[QUASH]\$ echo Hey Quash! > a.txt  \# Truncate the previous contents of a.txt and write "Hey Quash!\(\backslash\)n" to the file}
\DoxyCodeLine{[QUASH]\$ cat a.txt          \# Print file contents. If we didn't actually truncate we would see "Hey Quash!h!\(\backslash\)n" as the output of this command.}
\DoxyCodeLine{Hey Quash!}
\DoxyCodeLine{[QUASH]\$ cat < a.txt        \# Make cat read from a.txt via standard in}
\DoxyCodeLine{Hey Quash!}
\DoxyCodeLine{[QUASH]\$ cat < a.txt > b.txt  \# Multiple redirect. Read from a.txt and write to b.txt.}
\DoxyCodeLine{[QUASH]\$ cat b.txt}
\DoxyCodeLine{Hey Quash!}
\DoxyCodeLine{[QUASH]\$ cat a.txt >> b.txt  \# Append output of a.txt to b.txt}
\DoxyCodeLine{[QUASH]\$ cat b.txt}
\DoxyCodeLine{Hey Quash!}
\DoxyCodeLine{Hey Quash!}
\DoxyCodeLine{[QUASH]\$}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{[QUASH]\$ cat src/quash.c | grep running}
\DoxyCodeLine{// Check if loop is running}
\DoxyCodeLine{bool is\_running() \{}
\DoxyCodeLine{  return state.running;}
\DoxyCodeLine{  state.running = false;}
\DoxyCodeLine{  while (is\_running()) \{}
\DoxyCodeLine{[QUASH]\$ cat src/quash.c | grep running | grep return}
\DoxyCodeLine{  return state.running;}
\end{DoxyCode}
\hypertarget{index_autotoc_md5}{}\doxysubsubsection{Built-\/in Functions}\label{index_autotoc_md5}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{[QUASH]\$ echo Hello world! 'How are you today?'}
\DoxyCodeLine{Hello world! How are you today?}
\DoxyCodeLine{[QUASH]\$ echo \$HOME/Development}
\DoxyCodeLine{/home/jrobinson/Development}
\DoxyCodeLine{[QUASH]\$}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{[QUASH]\$ export PATH=/usr/bin:/bin  \# Set the PATH environment variable}
\DoxyCodeLine{[QUASH]\$ echo \$PATH                 \# Print the current value of PATH}
\DoxyCodeLine{/usr/bin:/bin}
\DoxyCodeLine{[QUASH]\$ echo \$HOME}
\DoxyCodeLine{/home/jrobinson}
\DoxyCodeLine{[QUASH]\$ export PATH=\$HOME  \# Set the PATH environment variable to the value of HOME}
\DoxyCodeLine{[QUASH]\$ echo \$PATH         \# Print the current value of PATH}
\DoxyCodeLine{/home/jrobinson}
\DoxyCodeLine{[QUASH]\$}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{[QUASH]\$ echo \$PWD}
\DoxyCodeLine{/home/jrobinson}
\DoxyCodeLine{[QUASH]\$ cd ..              \# Go up one directory}
\DoxyCodeLine{[QUASH]\$ echo \$PWD}
\DoxyCodeLine{/home}
\DoxyCodeLine{[QUASH]\$ cd \$HOME           \# Go to path in the HOME environment variable}
\DoxyCodeLine{/home/jrobinson}
\DoxyCodeLine{[QUASH]\$}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{[QUASH]\$ pwd                \# Print the working directory}
\DoxyCodeLine{/home/jrobinson}
\DoxyCodeLine{[QUASH]\$ echo \$PWD          \# Print the PWD environment variable}
\DoxyCodeLine{/home/jrobinson}
\DoxyCodeLine{[QUASH]\$ export PWD=/usr    \# Change the PWD environment variable}
\DoxyCodeLine{[QUASH]\$ pwd}
\DoxyCodeLine{/home/jrobinson}
\DoxyCodeLine{[QUASH]\$ echo \$PWD}
\DoxyCodeLine{/usr}
\DoxyCodeLine{[QUASH]\$}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{[BASH]\$ ./quash}
\DoxyCodeLine{Welcome...}
\DoxyCodeLine{[QUASH]\$ exit}
\DoxyCodeLine{[BASH]\$ ./quash}
\DoxyCodeLine{Welcome...}
\DoxyCodeLine{[QUASH]\$ quit}
\DoxyCodeLine{[BASH]\$}
\end{DoxyCode}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{[QUASH]\$ find -\/type f | grep '*.c' > out.txt \&}
\DoxyCodeLine{Background job started: [1]    2342    find / -\/type f | grep '*.c' > out.txt \&}
\DoxyCodeLine{[QUASH]\$ sleep 15 \&}
\DoxyCodeLine{Background job started: [2]    2343    sleep 15 \&}
\DoxyCodeLine{[QUASH]\$ jobs               \# List currently running background jobs}
\DoxyCodeLine{[1]    2342    find / -\/type f | grep '*.c' > out.txt \&}
\DoxyCodeLine{[2]    2343    sleep 15 \&}
\DoxyCodeLine{[QUASH]\$}
\end{DoxyCode}
\hypertarget{index_autotoc_md6}{}\doxysubsection{Useful Functions in the Quash Skeleton}\label{index_autotoc_md6}
The following are some funtions outside of \mbox{\hyperlink{execute_8c}{src/execute.\+c}} that you may want to use in your implementation\+:


\begin{DoxyItemize}
\item {\itshape \mbox{\hyperlink{quash_8c_ab43880685b2507434e4a84f2cb9d54d4}{get\+\_\+command\+\_\+string()}}} 
\item {\itshape destroy\+\_\+parser()} 
\item Things in \mbox{\hyperlink{deque_8h}{src/deque.\+h}}. Quash can make due with only implementations of this data structure (i.\+e. background jobs list, process id list). These are preprocessor macro definitions of the data structure and will expand and specialize to a type when used (similar to templates in c++). See example usage at the bottom of \mbox{\hyperlink{deque_8h}{src/deque.\+h}}. {\bfseries{You don\textquotesingle{}t have to use this deque implementation if you would rather write your own list data structure.}}
\begin{DoxyItemize}
\item {\itshape \mbox{\hyperlink{deque_8h_a091cfc1289538b13036bcd36d12a3c01}{I\+M\+P\+L\+E\+M\+E\+N\+T\+\_\+\+D\+E\+Q\+U\+E\+\_\+\+S\+T\+R\+U\+C\+T()}}} -\/ Generates the double ended queue structure specialized to a type
\item {\itshape \mbox{\hyperlink{deque_8h_af9dc10c0d5c775afe3053629e39f8c36}{P\+R\+O\+T\+O\+T\+Y\+P\+E\+\_\+\+D\+E\+Q\+U\+E()}}} -\/ Generates the function prototypes for the functions that are generated by the {\itshape \mbox{\hyperlink{deque_8h_a71fbe309fa88eb8d294b141f33d81233}{I\+M\+P\+L\+E\+M\+E\+N\+T\+\_\+\+D\+E\+Q\+U\+E()}}} macro
\item {\itshape \mbox{\hyperlink{deque_8h_a71fbe309fa88eb8d294b141f33d81233}{I\+M\+P\+L\+E\+M\+E\+N\+T\+\_\+\+D\+E\+Q\+U\+E()}}} -\/ Generates functions for use with the structure generated by {\itshape \mbox{\hyperlink{deque_8h_a091cfc1289538b13036bcd36d12a3c01}{I\+M\+P\+L\+E\+M\+E\+N\+T\+\_\+\+D\+E\+Q\+U\+E\+\_\+\+S\+T\+R\+U\+C\+T()}}}.
\begin{DoxyItemize}
\item N\+O\+TE\+: The following functions were generated with a call to {\itshape \mbox{\hyperlink{deque_8h_a71fbe309fa88eb8d294b141f33d81233}{I\+M\+P\+L\+E\+M\+E\+N\+T\+\_\+\+D\+E\+Q\+U\+E(\+Example, Type)}}}. Each function is named after the contents passed into the first argment of this macro (in this case {\itshape \mbox{\hyperlink{structExample}{Example}}}).
\item {\itshape \mbox{\hyperlink{group__DEQUE_gae0c6f52c89e2b087e19e3062186144da}{new\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_ga4a210705b6f22fe97b7033bb8854a4d6}{new\+\_\+destructable\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_gad9998ed1cadaff66c209e8b666185f70}{destroy\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_gab8ed3578aa5708a09831653caaa88b8a}{empty\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_ga43fb8662cb9960b573bc2368b27a915c}{is\+\_\+empty\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_gab751404fe5166cbc70dc8093b5167839}{length\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_ga0214e3a819ca3e1ec44d2f60d7c28f7b}{as\+\_\+array\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_ga582c40f070af171e4c98455d7d6fd305}{apply\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_ga7ef7f1f62eb4aa5565c04013ac376433}{push\+\_\+front\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_ga63a0566b60e881121b5ba029a25cb9ae}{push\+\_\+back\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_ga9fe851644b8743ed3e189e2b7872641a}{pop\+\_\+front\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_gaa3a49a1ed1aac021037fe94820ed8c95}{pop\+\_\+back\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_gab65f67206d60592e7a12d4ed1c833cc1}{peek\+\_\+front\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_ga17ee221f1873599af8849e47af1d490c}{peek\+\_\+back\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_ga2f5457e6575eb38d59b7504770ca247e}{update\+\_\+front\+\_\+\+Example()}}} 
\item {\itshape \mbox{\hyperlink{group__DEQUE_ga0705ac52e0952213b9f1ce7f80bf977e}{update\+\_\+back\+\_\+\+Example()}}} 
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{index_autotoc_md7}{}\doxysubsection{Useful System Calls and Library Functions}\label{index_autotoc_md7}
...
You may N\+OT use the system(3) function anywhere in your project\hypertarget{index_autotoc_md8}{}\doxysubsection{Project Hints and Comments}\label{index_autotoc_md8}
...
The structure of the functions in \mbox{\hyperlink{execute_8c}{src/execute.\+c}} will be explained in the following paragraphs.

The entry level function for execution in quash is {\itshape \mbox{\hyperlink{execute_8c_a4dab67459028f3b5a60d1a3695933f4b}{run\+\_\+script()}}}. This function is responsible for calling {\itshape \mbox{\hyperlink{execute_8c_acffe0d67f5dfe68ccf3765cf8ae29dab}{create\+\_\+process()}}} on an array of {\itshape Command\+Holders}. After all of the processes have been created for a job, \mbox{\hyperlink{execute_8c_a4dab67459028f3b5a60d1a3695933f4b}{run\+\_\+script()}} should either wait on all processes inside a foreground job to complete or add it to the background job list without waiting if it is a background job.

The {\itshape \mbox{\hyperlink{execute_8c_acffe0d67f5dfe68ccf3765cf8ae29dab}{create\+\_\+process()}}} function is intended to be the place where you fork processes, handle pipe creation, and file redirection. You should not call execvp(3) from this function. Instead you should call derivatives of the {\itshape example\+\_\+run\+\_\+command()} function. Also you can determine whether you should use the boolean variables at the top of this function to determine if pipes and redirects should be setup. It may be necessary to keep a global execution state structure so that different calls to create process can view important information created in previous invocations of \mbox{\hyperlink{execute_8c_acffe0d67f5dfe68ccf3765cf8ae29dab}{create\+\_\+process()}} (i.\+e. the file descriptors for open pipes of previous processes).

When implementing the run\+\_\+$<$command type$>$ functions in \mbox{\hyperlink{execute_8c}{src/execute.\+c}}, the command structures usually hold everything needed to pass to the corresponding function calls. For example, the {\itshape \mbox{\hyperlink{structGenericCommand}{Generic\+Command}}} structure contains an args field fully formatted and ready to pass into the argv argument of the {\itshape execvp(3)} library function. The one exception to this rule is {\itshape \mbox{\hyperlink{execute_8c_a8e9aed155e5ccf7e207a8f3ce4789d83}{run\+\_\+cd()}}}. In the {\itshape \mbox{\hyperlink{structCDCommand}{C\+D\+Command}}} structure, the field dir is the path that the user typed. This needs to be expanded to an absolute path with {\itshape realpath(3)} before you use it.

You should not have to search for environment variables (\$) in your functions. The parser uses your implementation of {\itshape \mbox{\hyperlink{execute_8c_afeab372587374ba444aa9bdfb6cfa0d8}{lookup\+\_\+env()}}} function to expand the environment variables for you.\hypertarget{index_autotoc_md9}{}\doxysubsection{Testing}\label{index_autotoc_md9}
...
\end{DoxyItemize}\hypertarget{index_autotoc_md10}{}\doxysubsection{Grading Policy}\label{index_autotoc_md10}
...
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Description  }&\cellcolor{\tableheadbgcolor}\textbf{ Score   }\\\cline{1-2}
\endfirsthead
\hline
\endfoot
\hline
...
\item \mbox{\hyperlink{structRedirect}{Redirect}} standard input to any command from file (cat $<$ a.\+txt)  
\item \mbox{\hyperlink{structRedirect}{Redirect}} standard output from a command to a file (cat b.\+txt $>$ a.\+txt)  
...
\end{longtabu}
\hypertarget{index_autotoc_md11}{}\doxysubsection{Submission}\label{index_autotoc_md11}
Each group should submit the project to your TA via Blackboard. Create a zip file of your code using \char`\"{}make submit\char`\"{}. You should also check that the zipped project still builds and runs correctly after building the submit target with \char`\"{}make unsubmit\char`\"{}. Your TA will be using this command to extract and build your project so make sure it works correctly. If you modify either of these targets, please ensure all file extensions are renamed to \char`\"{}.\+txt\char`\"{} in the submission and extract correctly with the unsubmit target.\hypertarget{index_autotoc_md12}{}\doxysubsection{Miscellaneous}\label{index_autotoc_md12}
