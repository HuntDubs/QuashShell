...
/**
 * @brief Generates a @a memory_pool_alloc based set of functions for use with a
 * structure generated by @a IMPLEMENT_DEQUE_STRUCT
 *
 * @param struct_name The name of the structure
 *
 * @param type The name of the type of elements stored in the @a struct_name
...
/**
 * @defgroup DEQUE An implementation of a double ended queue
 * @{
 */
 ...
 * or IMPLEMENT_DEQUE_MEMORY_POOL() macros.
 *
 * @sa IMPLEMENT_DEQUE(), IMPLEMENT_DEQUE_MEMORY_POOL()
 */
 ...
 * deque destroying any malloc'd memory in each element. The destructor function
 * should not free any memory residing in memory pools.
 *
 * @param init_cap Initial capacity of the deque
 *
 ...
 *
 * @brief Quickly empties the deque structure
 *
 ...
 * responsible for freeing the memory of the array. If this function was created
 * with the @a IMPLEMENT_DEQUE_MEMORY_POOL() then the array will be freed
 * automatically by the call to @a destroy_memory_pool().
 *
